...
ces0411$union04<-Recode(ces0411$ces04_CPS_S6A, "1=1; 5:8=0; else=NA")
...
ces0411 %>% 
  mutate(union_both04=case_when(
    ...
    ces04_CPS_S6A==8 | ces04_CPS_S6B==8 ~ 0,
...
#recode Union Respondent (ces06_CPS_S6A)

ces0411$union06<-Recode(ces0411$ces06_CPS_S6A, "1=1; 5:8=0; else=NA")
...
ces0411 %>% 
  mutate(union_both06=case_when(
    ...
    ces06_CPS_S6A==8 | ces06_CPS_S6B==8 ~ 0,
...
ces0411$union08<-Recode(ces0411$ces08_CPS_S6A, "1=1; 5:8=0; else=NA")
...
ces0411 %>% 
  mutate(union_both08=case_when(
    ...
    ces08_CPS_S6A==8 | ces08_CPS_S6B==8 ~ 0,
...
look_for(ces0411, "union")
ces0411$union11<-Recode(ces0411$PES11_93, "1=1; 5:8=0; else=NA")
