...
#NDP
ndp_models1ROC<-glm(ndp~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+language+foreign+as.factor(income3), data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
ndp_models1QC<-glm(ndp~working_class+union_both+young+old+male+sector+catholic+no_religion+degree+language+foreign+as.factor(income3), data=ces.out, family="binomial")
summary(ndp_models1ROC)
summary(ndp_models1QC)

#Liberal
lib_models1ROC<-glm(liberal~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+language+foreign+as.factor(income3), data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
lib_models1QC<-glm(liberal~working_class+union_both+young+old+male+sector+catholic+no_religion+degree+language+foreign+as.factor(income3), data=ces.out, family="binomial")
summary(lib_models1ROC)
summary(lib_models1QC)

#Conservative
con_models1ROC<-glm(conservative~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+language+foreign+as.factor(income3), data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
con_models1QC<-glm(conservative~working_class+union_both+young+old+male+sector+catholic+no_religion+degree+language+foreign+as.factor(income3), data=ces.out, family="binomial")
summary(con_models1ROC)
summary(con_models1QC)

#Model 2 - low and high income quintiles
ndp_models2ROC<-glm(ndp~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
ndp_models2QC<-glm(ndp~working_class+union_both+young+old+male+degree+language+foreign, data=ces.out, family="binomial")
summary(ndp_models2ROC)
summary(ndp_models2QC)

#Liberal
lib_models2ROC<-glm(liberal~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
lib_models2QC<-glm(liberal~working_class+union_both+young+old+male+degree+language+foreign, data=ces.out, family="binomial")
summary(lib_models2ROC)
summary(lib_models2QC)

#Conservative
con_models2ROC<-glm(conservative~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
con_models2QC<-glm(conservative~working_class+union_both+young+old+male+degree+language+foreign, data=ces.out, family="binomial")
...
ces15phone %>% 
  filter(quebec==1)->ces.out
bloc_models2QC<-glm(bloc~working_class+union_both+young+old+male+degree+language+foreign, data=ces.out, family="binomial")
summary(bloc_models2QC)

#Model 3 - Political Orientations
#NDP
ndp_models3ROC<-glm(ndp~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income+market_liberalism+moral_traditionalism+political_disaffection+continentalism, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
ndp_models3QC<-glm(ndp~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty, data=ces.out, family="binomial")
summary(ndp_models3ROC)
summary(ndp_models3QC)

#Liberal
lib_models3ROC<-glm(liberal~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income+market_liberalism+moral_traditionalism+political_disaffection+continentalism, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
lib_models3QC<-glm(liberal~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty, data=ces.out, family="binomial")
summary(lib_models3ROC)
summary(lib_models3QC)

#Conservative
con_models3ROC<-glm(conservative~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income+market_liberalism+moral_traditionalism+political_disaffection+continentalism, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
con_models3QC<-glm(conservative~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty, data=ces.out, family="binomial")
...
ces15phone %>% 
  filter(quebec==1)->ces.out
bloc_models3QC<-glm(bloc~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty, data=ces.out, family="binomial")
summary(bloc_models3QC)

#Model 4 - Partisanship
#NDP
ndp_models4ROC<-glm(ndp~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income+market_liberalism+moral_traditionalism+political_disaffection+continentalism+ndp_id, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
ndp_models4QC<-glm(ndp~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty+ndp_id, data=ces.out, family="binomial")
summary(ndp_models4ROC)
summary(ndp_models4QC)

#Liberal
lib_models4ROC<-glm(liberal~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income+market_liberalism+moral_traditionalism+political_disaffection+continentalism+liberal_id, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
lib_models4QC<-glm(liberal~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty+liberal_id, data=ces.out, family="binomial")
summary(lib_models4ROC)
summary(lib_models4QC)

#Conservative
con_models4ROC<-glm(conservative~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income+market_liberalism+moral_traditionalism+political_disaffection+continentalism+conservative_id, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
con_models4QC<-glm(conservative~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty+conservative_id, data=ces.out, family="binomial")
...
ces15phone %>% 
  filter(quebec==1)->ces.out
bloc_models4QC<-glm(bloc~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty+bloc_id, data=ces.out, family="binomial")
summary(bloc_models4QC)

#Model 5 - Economic Perceptions
#NDP
ndp_models5ROC<-glm(ndp~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income+market_liberalism+moral_traditionalism+political_disaffection+continentalism+ndp_id+personal_retrospective+national_retrospective, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
ndp_models5QC<-glm(ndp~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty+ndp_id+personal_retrospective+national_retrospective, data=ces.out, family="binomial")
summary(ndp_models5ROC)
summary(ndp_models5QC)

#Liberal
lib_models5ROC<-glm(liberal~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income+market_liberalism+moral_traditionalism+political_disaffection+continentalism+liberal_id+personal_retrospective+national_retrospective, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
lib_models5QC<-glm(liberal~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty+liberal_id+personal_retrospective+national_retrospective, data=ces.out, family="binomial")
...
ces15phone %>% 
  filter(quebec==1)->ces.out
con_models5QC<-glm(conservative~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty+conservative_id+personal_retrospective+national_retrospective, data=ces.out, family="binomial")
...
ces15phone %>% 
  filter(quebec==1)->ces.out
bloc_models5QC<-glm(bloc~working_class+union_both+young+old+male+degree+language+foreign+market_liberalism+moral_traditionalism+political_disaffection+continentalism+quebec_sovereignty+bloc_id+personal_retrospective+national_retrospective, data=ces.out, family="binomial")
summary(bloc_models5QC)

#Model 6 - Policy Issues
#NDP
ndp_models6ROC<-glm(ndp~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income+market_liberalism+moral_traditionalism+political_disaffection+continentalism+ndp_id+personal_retrospective+national_retrospective+immigration_rate+environment+redistribution+defence, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
...
#Conservative
con_models6ROC<-glm(conservative~region3+working_class+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income+market_liberalism+moral_traditionalism+political_disaffection+continentalism+conservative_id+personal_retrospective+immigration_rate+national_retrospective+environment+redistribution+defence, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
...
#NDP
ndp_models8ROC<-glm(ndp~region3+working_class2+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
ndp_models8QC<-glm(ndp~working_class2+union_both+young+old+male+degree+language+foreign, data=ces.out, family="binomial")
summary(ndp_models8ROC)
summary(ndp_models8QC)

#Liberal
lib_models8ROC<-glm(liberal~region3+working_class2+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
lib_models8QC<-glm(liberal~working_class2+union_both+young+old+male+degree+language+foreign, data=ces.out, family="binomial")
summary(lib_models8ROC)
summary(lib_models8QC)

#Conservative
con_models8ROC<-glm(conservative~region3+working_class2+union_both+young+old+male+sector+catholic+no_religion+degree+foreign+low_income+high_income, data=ces15phone, family="binomial")
ces15phone %>% 
  filter(quebec==1)->ces.out
con_models8QC<-glm(conservative~working_class2+union_both+young+old+male+degree+language+foreign, data=ces.out, family="binomial")
...
ces15phone %>% 
  filter(quebec==1)->ces.out
bloc_models8QC<-glm(bloc~working_class2+union_both+young+old+male+degree+language+foreign, data=ces.out, family="binomial")
