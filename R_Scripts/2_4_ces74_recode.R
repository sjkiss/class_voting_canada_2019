...
#recode Gender (V480)
look_for(ces74, "sex")
ces74$male<-Recode(ces74$V479, "1=1; 2=0; 9=NA")
...
ces74$degree<-Recode(ces74$V413, "25=1; 0:13=0")
...
ces74$region<-Recode(ces74$V1, "0:3=1; 5=2; 6:9=3; 4=NA; 99=NA")
...
#recode Quebec (V6)
look_for(ces74, "province")
ces74$quebec<-Recode(ces74$V1, "0:3=0; 5:9=0; 4=1; 99=NA")
...
#recode Age (V478)
look_for(ces74, "age")
ces74$age<-ces74$V477
ces74$age<-Recode(ces74$V477, "0=NA")
#check
table(ces74$age)

#recode Religion (V453)
look_for(ces74, "relig")
ces74$religion<-Recode(ces74$V452, "0=0; 15=0; 1=1; 2:6=2; 7:8=1; 10:14=2; 16:25=2; 27:88=NA; else=3")
...
ces74$language<-Recode(ces74$V8, "2=0; 1=1; else=NA")
...
look_for(ces74, "language")
ces74$non_charter_language<-Recode(ces74$V470, "1:2=0; 3=1; 4:7=1; else=NA")
...
ces74$party_id<-Recode(ces74$V130, "1=1; 2=2; 3=3; 0=0; 4:5=0; else=NA")
...
#recode Vote (V162)
look_for(ces74, "vote")
ces74$vote<-Recode(ces74$V161, "1=1; 2=2; 3=3; 4:5=0; else=NA")
...
look_for(ces74, "occupation")
ces74$occupation<-Recode(ces74$V410, "11:12=1; 21:22=2; 30=3; 41:42=4; 43:50=5; else=NA")
...
ces74$income<-Recode(ces74$V478, "1:2=1; 3:4=2; 5=3; 6=4; 7:8=5; else=NA")
...
ces74$size<-Recode(ces74$V480, "8:9=1; 7=2; 5:6=3; 4=4; 1:3=5; else=NA")
